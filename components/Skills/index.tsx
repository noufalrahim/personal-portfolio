...
export default function Skills() {
    ...
    const mySkills = [
        ...
        {
          icon: <FaLaptop className="text-white text-4xl m-4" size={48} />,
        ...
        {
          icon: <FaConnectdevelop className="text-white text-4xl m-4" size={48} />,
            ...
            <div className="w-full flex flex-row justify-center items-center mx-10 gap-4 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 grid-cols-1">
                {
                    mySkills.map((item, index) => (
                        <div key={index} className="flex flex-col items-center justify-center p-5">
                            {item.icon}
                            <h4 className="text-white text-center text-2xl mb-5">
                                <code>
                                    {item.name}
                                </code>
                            </h4>
